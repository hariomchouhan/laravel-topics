...
<body>
    <div class="container">
        ...
        @csrf
            <input type="text" name="name" placeholder="Enter your Name" class="form-control mt-5">
            <input type="email" name="email" placeholder="Enter your Email" class="form-control mt-3">
